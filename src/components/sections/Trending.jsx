const Trending = ({name, year, category, rating, photo, bookmark, onMarcar, valor}) => {
  return (
    <div className="relative cursor-pointer h-[200px] group/principal">
        ...
        <div className="absolute hidden group-hover/principal:flex items-center bg-white bg-opacity-50 px-2 py-[5px] rounded-3xl 2xl:ml-[215px] xl:ml-36 2xl:mt-[100px] xl:mt-20">
